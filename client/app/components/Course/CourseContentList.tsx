  ...
  return (
    ...
    >
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        // Number of videos in the current section
        ...
        // Start index of videos within the current section
        const sectionStartIndex: number = totalCount;
        // Update the total count of videos
            ...
            {isSectionVisible && (
              <div className="w-full">
                {sectionVideos.map((item: any, index: number) => {
                  //Calculate the video index within the overall list
